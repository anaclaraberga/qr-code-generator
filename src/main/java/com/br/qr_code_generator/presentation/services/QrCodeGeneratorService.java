package com.br.qr_code_generator.presentation.services;
...
import com.br.qr_code_generator.infrastructure.ports.StoragePort;
...
public class QrCodeGeneratorService {
    ...
    public QrCodeGeneratorResponse generateQrCode(String text) throws WriterException, IOException {
